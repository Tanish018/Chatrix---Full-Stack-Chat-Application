...
import { MessageSquare, Eye, EyeOff, Loader2, Lock, Mail, User } from 'lucide-react'
import { Link } from 'react-router-dom'
import AuthImagePattern from '../components/AuthImagePattern.signup'
...
const SignUpPage = () => {
  ...
  return (
    <div className='min-h-screen grid lg:grid-cols-2'>
      <div className="left flex flex-col items-center justify-center p-6 sm:p-12">
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  className={`input active:ring-1 active:transition-all duration-75 w-full pl-10`}
