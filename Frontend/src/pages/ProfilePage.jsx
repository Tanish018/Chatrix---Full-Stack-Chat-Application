  ...
  return (
    <div className='h-screen pt-20'>
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className='bg-base-300 rounded-xl space-y-8 py-8 px-4'>
          <div className="text-center">
            <h1 className="font-bold text-[24px]">Profile</h1>
            <p className='font-semibold mt-2'>Your Profile Information</p>
          </div>
            ...
            <p className="text-sm text-zinc-400">
              {isUpdatingProfile ? "Uploading..." : (
                <>
                  ...
                  <span className='block text-center'>(Size should be less than 1 MB)</span>
                </>
              )}
            </p>
          </div>
